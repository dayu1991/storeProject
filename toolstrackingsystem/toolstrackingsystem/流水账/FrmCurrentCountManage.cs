...
namespace toolstrackingsystem
{
    public partial class FrmCurrentCountManage : Office2007RibbonForm
    {
        ...
        private void LoadData()
        {
            ...
            TollList_dataGridViewX.Columns[10].HeaderText = "出库时间";
            TollList_dataGridViewX.Columns[11].HeaderText = "归还时间"; 
            ...
            try
            {
                ...
                if (fileDialog.ShowDialog() == DialogResult.OK)
                {
                    ...
                    for (int i = 0; i < resultList.Count; i++)
                    {
                        ...
                        cell.SetCellType(NPOI.SS.UserModel.CellType.String);
                        cell.SetCellValue(item.OptionType);
                        ...
                        cell.SetCellType(NPOI.SS.UserModel.CellType.String);
                        cell.SetCellValue(item.describes);
