    ...
    public partial class cangku_manage_dbDataSet : global::System.Data.DataSet {
        ...
        public partial class t_PersonInfoRow : global::System.Data.DataRow {
            ...
            public string IsReceive {
                get {
                    try {
                        ...
                        throw new global::System.Data.StrongTypingException("表“t_PersonInfo”中列“IsReceive”的值为 DBNull。", e);
                    }
                }
                set {
            ...
            public bool IsIsReceiveNull() {
                return this.IsNull(this.tablet_PersonInfo.IsReceiveColumn);
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public void SetIsReceiveNull() {
                this[this.tablet_PersonInfo.IsReceiveColumn] = global::System.Convert.DBNull;
            }
        }
...
namespace toolstrackingsystem.cangku_manage_dbDataSetTableAdapters {
    ...
    public partial class t_PersonInfoTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[t_PersonInfo] ([PersonCode], [PersonName], [RFID], [Remarks], [OptionPerson]) VALUES (@PersonCode, @PersonName, @RFID, @Remarks, @OptionPerson);
SELECT PersonID, PersonCode, PersonName, RFID, Remarks, OptionPerson, CASE IsReceive WHEN 1 THEN '是' WHEN 0 THEN '否' END AS IsReceive FROM t_PersonInfo WHERE (PersonCode = @PersonCode)";
...
SELECT PersonID, PersonCode, PersonName, RFID, Remarks, OptionPerson, CASE IsReceive WHEN 1 THEN '是' WHEN 0 THEN '否' END AS IsReceive FROM t_PersonInfo WHERE (PersonCode = @PersonCode)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::toolstrackingsystem.Properties.Settings.Default.cangku_manage_dbConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT PersonID, PersonCode, PersonName, RFID, Remarks, OptionPerson, IsReceive =" +
                "case IsReceive when 1 then \'是\' when 0 then \'否\' end FROM dbo.t_PersonInfo";
        ...
        public virtual int Delete(long Original_PersonID, string Original_PersonCode, string Original_PersonName, string Original_RFID, string Original_Remarks, string Original_OptionPerson) {
        ...
        public virtual int Insert(string PersonCode, string PersonName, string RFID, string Remarks, string OptionPerson) {
            if ((PersonCode == null)) {
        ...
        public virtual int Update(string PersonCode, string PersonName, string RFID, string Remarks, string OptionPerson, long Original_PersonID, string Original_PersonCode, string Original_PersonName, string Original_RFID, string Original_Remarks, string Original_OptionPerson) {
            if ((PersonCode == null)) {
                throw new global::System.ArgumentNullException("PersonCode");
            }
            else {
            ...
            if ((Original_PersonCode == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[6].Value = ((string)(Original_PersonCode));
            }
            if ((Original_PersonName == null)) {
                throw new global::System.ArgumentNullException("Original_PersonName");
            }
            ...
            if ((Original_RFID == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[9].Value = ((string)(Original_RFID));
            }
            if ((Original_Remarks == null)) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string PersonName, string RFID, string Remarks, string OptionPerson, long Original_PersonID, string Original_PersonCode, string Original_PersonName, string Original_RFID, string Original_Remarks, string Original_OptionPerson) {
            return this.Update(Original_PersonCode, PersonName, RFID, Remarks, OptionPerson, Original_PersonID, Original_PersonCode, Original_PersonName, Original_RFID, Original_Remarks, Original_OptionPerson);
        }
    }
