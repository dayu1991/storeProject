...
{
    public partial class FrmCategoryManage : Office2007RibbonForm
    {
        ...
        private void LoadData()
        {
            try
            {
                ...
                var categorys = _toolInfoService.GetCategoryByClassify(2, name);
            ...
            {
                logger.ErrorFormat("具体位置={0},重要参数Message={1},StackTrace={2},Source={3}", "toolstrackingsystem--FrmCategoryManage--Search_buttonX_Click", ex.Message, ex.StackTrace, ex.Source);
            }
        }
        ...
        private void btnAdd_Click(object sender, EventArgs e)
        {
            ...
            {
                logger.ErrorFormat("具体位置={0},重要参数Message={1},StackTrace={2},Source={3}", "toolstrackingsystem--FrmCategoryManage--btnAdd_Click", ex.Message, ex.StackTrace, ex.Source);
        ...
        private void btnEdit_Click(object sender, EventArgs e)
        {
            ...
            {
                logger.ErrorFormat("具体位置={0},重要参数Message={1},StackTrace={2},Source={3}", "toolstrackingsystem--FrmCategoryManage--edit", ex.Message, ex.StackTrace, ex.Source);
        ...
        private void btnDelete_Click(object sender, EventArgs e)
        {
            ...
            catch (Exception ex)
            {
                ...
                logger.ErrorFormat("具体位置={0},重要参数Message={1},StackTrace={2},Source={3}", "toolstrackingsystem--FrmCategoryManage--delete", ex.Message, ex.StackTrace, ex.Source);
            }
        }
